<template>
  <div class="container" v-loading="loading">
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input placeholder="请输入站点名称" v-model="fuzzy" size="small" clearable></el-input>
      </el-col>
      <el-col :span="2">
   ...
   <!--   <el-table-column prop="stayTime" label="停留时间" align="center">
      </el-table-column>-->
    ...
    <el-dialog title="站点信息维护" :visible.sync="dialogFormVisible" width="30%" :before-close="handleClose" center>
      <el-form :rules="rules" :model="site" ref="Form">
        <el-form-item label="站点名称" prop="name">
          <el-input v-model="site.name" autocomplete="off"></el-input>
        </el-form-item>
     <!--   <el-form-item label="停留时间" prop="name">
          <el-input v-model="site.stayTime" autocomplete="off"></el-input>
        </el-form-item>-->
      </el-form>
...
<script>
    ...
    import {fetchInfo, updateInfo, addInfo, deleteInfo} from '@/api/site'
        ...
        /*          stayTime: ''*/
                ...
                rules: {
                   ...
                   /* stayTime: [
                        ...
                        {
                            type: 'number', message: '停留时间必须为数字值'
                        }
                    ]*/
                },
            }
