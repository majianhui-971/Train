<template>
  <div class="container" v-loading="loading">
    <el-row :gutter="20">
      <el-col :span="8">
        <el-input placeholder="请输入用户名、密码、邮箱、性别、真实姓名" v-model="fuzzy" size="small" clearable></el-input>
      </el-col>
      <el-col :span="2">
    ...
    <el-table :data="tableData" border stripe :header-cell-style="header" class="table" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="registerTime" label="注册时间" align="center" :formatter="dateFormat">
      </el-table-column>
      <el-table-column v-if="stateShow" prop="status" label="状态" align="center">
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
    ...
    import {fetchInfo, deleteInfo} from '@/api/customer'
