<template>
  <div class="container" v-loading="loading">
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input placeholder="请输入留言用户、父留言、内容" v-model="fuzzy" size="small" clearable></el-input>
      </el-col>
      <el-col :span="2">
        <el-button type="primary" size="small" icon="el-icon-search" @click="fetchDataInfo">搜索</el-button>
      </el-col>
      <el-col :span="3" :offset="12" style="text-align: center">
    ...
    <el-table :data="tableData" border stripe :header-cell-style="header" class="table" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="cName" label="留言用户" align="center">
      </el-table-column>
      <el-table-column prop="parentId" label="父留言" align="center">
      </el-table-column>
...
<script>
  ...
  import {fetchInfo, deleteInfo} from '@/api/comment'
